...
{% if java %}
        <li class="collection-item avatar" id="gradle">
            ...
            <pre>
 testCompile 'org.concordion:concordion:3.0.0'
            </pre>
            <br/>
...
{% endif %}
    ...
    {% if java %}
            <p><b><a href="http://dl.bintray.com/concordion/downloads/concordion-3.0.0.zip">concordion-3.0.0.zip</a></b></p>
            <br/>
