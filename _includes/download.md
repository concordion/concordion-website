...
{% if java %}
        <li class="collection-item avatar" id="gradle">
            ...
            <pre>
 testCompile 'org.concordion:concordion:2.0.0'
            </pre>
        </li>
...
{% if java %}
        <p><b><a href="http://dl.bintray.com/concordion/downloads/concordion-2.0.0.zip">concordion-2.0.0.zip</a></b> (1.1MB)</p>
{% elsif csharp %}
