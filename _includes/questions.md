...
The [Cubano]({{site.baseurl}}/cubano) framework integrates Concordion with a number of Concordion extensions, WebDriver and other open-source projects to provide a ready-made framework for web and API testing that creates beautiful living documentation.
